...
export default class Switch extends Component {
  static propTypes = {
    ...
    borderActive: ColorPropType,
    borderInactive: ColorPropType,
  ...
  render() {
    ...
    const {
      backgroundActive, backgroundInactive, borderActive, borderInactive,
    ...
    const interpolatedBorderdColor = switchAnimation.interpolate({
      inputRange: value ? [-this.offset, -1]: [1, this.offset],
      outputRange: [borderInactive, borderActive],
      extrapolate: 'clamp'
    })
    ...
    return (
      <Animated.View
        ...
        style={[styles.container, style, {
          width, height,
          alignItems,
          borderColor: interpolatedBorderdColor,
